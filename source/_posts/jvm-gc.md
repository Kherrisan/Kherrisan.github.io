...
![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_11-14-44.jpg) 从一些被视为GC Root对象开始，从这些节点开始向下搜索，搜索经过的路径被称作引用链，如果一个对象到GC Roots没有任何引用链相连（不可达），就说明这个对象是个垃圾。 GC Roots包含以下几种对象：
...
![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-25-53.jpg) 四个步骤：
...
很简单，把Eden和Survivor中的对象做标记复制，复制到另一个Survivor或者提升到老年代中。需要Stop the World。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-37-34.jpg)![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-38-03.jpg)

### 对于老年代对象

首先，初始标记，标记所有GC Roots直接关联的对象。实际上这一步是在新生代GC的过程中顺带着做的。需要Stop the World。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-30-59.jpg) 接下来，并发标记，也就是做完整的可达性分析。这一步是和执行线程并行的。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-45-02.jpg) 如果有空的region（整个region不可达）就直接释放掉。 然后，重新标记。完成所有对象的可达性分析，同时计算每个对象的“活跃度”。需要stop the world。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-46-43.jpg) 再然后，把存活的对象复制到survivor或者提升到老年代中。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-47-59.jpg) 就结束了。 ![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-06_20-50-38.jpg)
