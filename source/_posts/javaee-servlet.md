...
既然是标准，那肯定要有interface。 ![](https://www.dokyme.cn/wp-content/uploads/2018/04/v2-85bf84640fbc6b6e195b9c5b513b918f_hd.jpg)

生命周期
====

![](https://www.dokyme.cn/wp-content/uploads/2018/04/Snipaste_2018-04-30_20-27-04.jpg) Servlet的生命周期比较简单，过程中经历的函数也不是很多。
...
![](https://www.dokyme.cn/wp-content/uploads/2018/05/Snipaste_2018-05-01_15-28-55.jpg) 每种监听器都有数个类似的方法，如监听对象的创建、销毁事件，增加、修改、删除某个属性的事件。有的监听器会有一些独特的方法。这里不详细解释每个监听器的原型。
...
![](https://www.dokyme.cn/wp-content/uploads/2018/05/invfilt.gif) 当一个web请求到来时，首先在在该请求上注册监听器（只有针对于请求的监听器才会再此时注册，针对其他对象的监听器在其他时刻注册，因为说不定其他对象还没有实例化呢），然后经过多个过滤器，最终到达servlet。  
