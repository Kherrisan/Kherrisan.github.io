...
![](https://www.dokyme.cn/wp-content/uploads/2018/09/6f431e4c3251e60f0ba1376cb918b5d4.png) 在HashMap的removeNode方法中被调用。这个方法在一个节点被删除之后，删除该节点存在的前向和后向链接，并将该节点的前驱的后向链接和后继节点的前向链接重新设置。

### afterNodeInsertion

![](https://www.dokyme.cn/wp-content/uploads/2018/09/0e70b312ef4a5d30d59b107fbafcaa59.png) 在HashMap的putVal方法中被调用。在插入新的节点之后，根据需求判断是否需要把最老的节点删掉，如果需要，就调用HashMap的removeNode方法。默认的判断结果为false。

### aftetNodeAccess

![](https://www.dokyme.cn/wp-content/uploads/2018/02/Snipaste_2018-02-17_13-14-41.jpg) 在HashMap的putVal方法中被使用到。在访问某个节点后（比如通过put修改该节点的值），把该节点移动到链表的最后。

### transferLinks

![](https://www.dokyme.cn/wp-content/uploads/2018/02/Snipaste_2018-02-17_13-34-35.jpg) 拷贝src节点的链接情况到dst节点上。
